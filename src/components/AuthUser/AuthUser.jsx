    ...
    <>
        <div>
            <div className={`bg-[#131314] items-center text-center justify-center flex `} style={{height:` ${height}px`}}>
                <div className={`md:w-[${formwidth}px] overflow-hidden shadow-lg  ${showLogin ? `shadow-[#ff7b7b]`: `shadow-[#02919B]` } rounded-2xl `} style={{ height:`${formheight}px`}}>
...
{/* LOGIN  */}
                    ...
                    <div className={`transition-all duration-500 ease-in-out bg-cover bg-center bg-no-repeat items-center flex flex-col justify-center text-center rounded-b-2xl rounded-tl-[100px] md:rounded-tl-[130px] shadow-[0_-10px_30px_-15px_rgba(0,0,0,0.3)] shadow-[#ff7b7b] `} style={{
                            ...
                            <div className=' md:px-16 px-10 w-full flex flex-col gap-8 justify-center  ' style={{ height:`${loginheight}px`}}>
                                ...
                                <div className='flex flex-col gap-3 w-[100%]'>
                                    ...
                                    <div className=' flex text-[#b1b1b1] gap-2 hover:text-[#ff7b7b]'>
                                        <a href=""><p>Forgot password? </p></a>
                                    </div>
                                </div>
                                <div className=' flex text-[#b1b1b1] gap-2'>
                                    <p>Don't have an account? </p><a href="#" onClick={toggleForm}><h1 className=' text-[#a9a9a9] font-bold hover:text-[#ED0200]'>Signup</h1></a>
                                </div>
